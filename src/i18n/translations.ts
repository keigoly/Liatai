...
export const translations = {
    ja: {
        ...
        folderColor: '色',
        folderSubColor: 'サブ色（任意・選ぶと2色になります）',
        folderSubColorNone: 'サブ色なし（単色に戻す）',
    ...
    en: {
        ...
        folderColor: 'Color',
        folderSubColor: 'Sub color (optional — makes it two-tone)',
        folderSubColorNone: 'No sub color (back to a single tone)',
